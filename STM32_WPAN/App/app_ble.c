...
HRC_APP_ConnHandle_Not_evt_t handleNotification;
...
void APP_BLE_Init(void)
{
  ...
  /**
   * Initialize Heart Rate Client Application
   */
  HRC_APP_Init();
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *pckt)
{
  ...
  switch (event_pckt->evt)
  {
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      {
        handleNotification.HR_Evt_Opcode = HR_DISCON_HANDLE_EVT;
          ...
          case ACI_L2CAP_CONNECTION_UPDATE_REQ_VSEVT_CODE:
            {
              ...
              APP_BLE_HR_Conn_Update_req.Identifier = pr->Identifier;
              APP_BLE_HR_Conn_Update_req.L2CAP_Length = pr->L2CAP_Length;
              APP_BLE_HR_Conn_Update_req.Interval_Min = pr->Interval_Min;
              APP_BLE_HR_Conn_Update_req.Interval_Max = pr->Interval_Max;
              APP_BLE_HR_Conn_Update_req.Latency = pr->Latency;
              APP_BLE_HR_Conn_Update_req.Timeout_Multiplier = pr->Timeout_Multiplier;

              ret = aci_l2cap_connection_parameter_update_resp(BleApplicationContext.BleApplicationContext_legacy.connectionHandle,
                                                               APP_BLE_HR_Conn_Update_req.Interval_Min,
                                                               APP_BLE_HR_Conn_Update_req.Interval_Max,
                                                               APP_BLE_HR_Conn_Update_req.Latency,
                                                               APP_BLE_HR_Conn_Update_req.Timeout_Multiplier,
                                                               CONN_L1,
                                                               CONN_L2,
                                                               APP_BLE_HR_Conn_Update_req.Identifier,
                                                               0x01);
              if(ret != BLE_STATUS_SUCCESS)
              {
    ...
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
      {
        ...
        if (cc->Connection_Handle == BleApplicationContext.BleApplicationContext_legacy.connectionHandle)
        {
          ...
          HRC_APP_Notification(&handleNotification);
        }
      }
    ...
    case HCI_LE_META_EVT_CODE:
      {
        ...
        switch (meta_evt->subevent)
        {
          ...
          case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
            ...
            handleNotification.HR_Evt_Opcode = HR_CONN_HANDLE_EVT;
            handleNotification.ConnectionHandle = BleApplicationContext.BleApplicationContext_legacy.connectionHandle;
            HRC_APP_Notification(&handleNotification);
                  ...
                  switch (adtype)
                  {
                    ...
                    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA: /* Manufacturer Specific */
                      ...
                      { /* ST VERSION ID 01 */
                        ...
                        {   /* Demo ID */
                           case CFG_DEV_ID_HR_SENSOR1: /* End Device 1 */
...
{
  if(HeartRate_Client_APP_Get_State () != APP_BLE_CONNECTED_CLIENT)
  {
    UTIL_SEQ_SetTask(1 << CFG_TASK_START_SCAN_ID, CFG_SCH_PRIO_0);
  }
  else 
  {
    HRC_APP_SW1_Button_Action();
  }   
}
